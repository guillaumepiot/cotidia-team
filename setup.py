...
template_files = package_files([
    'cotidia/team/templates',
    'cotidia/team/static'
])

setup(
    name="cotidia-team",
    description="Team plugin for Cotidia Admin.",
    version="1.0",
    author="Guillaume Piot",
    author_email="guillaume@cotidia.com",
    url="https://code.cotidia.com/cotidia/team/",
    packages=find_packages(),
    package_dir={'team': 'team'},
    package_data={
        'cotidia.team': template_files
    },
